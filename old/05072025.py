...
1. **🏭 Origem SP fixa** - Simplifica interface
2. **📊 Cálculo ICMS-ST** - Com IPI na base e FCP por estado
3. **🎯 Edição individual** - Comissão/bonificação editáveis
4. **⚖️ Ponto de equilíbrio** - Método iterativo para FCP
5. **🔢 Arredondamento** - Elimina valores -0.00
6. **📋 Interface estável** - Edição funciona na primeira tentativa
7. **📈 Exportação** - Excel completo com resumo
